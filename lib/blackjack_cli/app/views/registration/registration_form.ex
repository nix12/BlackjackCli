defmodule BlackjackCli.Views.Registration.RegistrationForm do
  ...
  def start_link(_) do
    GenServer.start_link(__MODULE__, :ok, name: BlackjackCli.via_tuple(@registry, :registration))
  end
  ...
  def get_field(field) do
    GenServer.call(BlackjackCli.via_tuple(@registry, :registration), {:get_field, field})
  end
  ...
  @spec get_fields :: map()
  def get_fields() do
    GenServer.call(BlackjackCli.via_tuple(@registry, :registration), {:get_fields})
  end
  ...
  def update_field(field, input) do
    GenServer.call(
      BlackjackCli.via_tuple(@registry, :registration),
  ...
  @spec close_form :: :ok
  def close_form do
    GenServer.stop(BlackjackCli.via_tuple(@registry, :registration), :normal)
  end
